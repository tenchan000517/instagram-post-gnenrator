...
interface Type002IntroTemplateProps {
  data: {
    title?: string;
...
export default function Type002IntroTemplate({ data }: Type002IntroTemplateProps) {
  const {
    title = '',
    targetAudience = '',
    problems = [],
...
export const type002IntroMetadata: TemplateMetadata = {
  id: 'type002_intro',
  name: 'Type002導入型',
  description: 'Type002用の導入テンプレート。タイトル、ターゲット質問、問題リストを表示。king.png使用、オレンジ背景',
  suitableFor: {
    contentTypes: ['導入', '問題提起', 'イントロダクション'],
    genres: ['スキルアップ', '実践系', 'Type002'],
  ...
  keywords: ['導入', '問題提起', 'Type002', '実践系', 'スキルアップ']
}