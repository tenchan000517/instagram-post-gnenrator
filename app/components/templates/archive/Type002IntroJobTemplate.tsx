...
interface Type002IntroJobTemplateProps {
  data: {
    title?: string;
...
export default function Type002IntroJobTemplate({ data }: Type002IntroJobTemplateProps) {
  const {
    title = '',
    targetAudience = '',
    problems = [],
  ...
  return (
    <div className="w-full h-full bg-gradient-to-b from-orange-50 to-white flex flex-col justify-center items-center p-8 relative">
      {/* メインタイトル */}
...
export const type002IntroJobMetadata: TemplateMetadata = {
  id: 'type002_intro_job',
  name: 'Type002導入型（就活）',
  description: 'Type002就活用の導入テンプレート。iida.png使用、オレンジ背景',
  suitableFor: {
    contentTypes: ['導入', '問題提起', 'イントロダクション'],
    genres: ['就活', '転職', 'スキルアップ', 'Type002'],
  ...
  keywords: ['導入', '問題提起', 'Type002', '就活', 'スキルアップ']
}