...
export default function Type001IntroJobTemplate({ data }: Type001IntroJobTemplateProps) {
  const {
    title = '',
    targetAudience = '',
    problems = [],
...
export const type001IntroJobMetadata: TemplateMetadata = {
  id: 'type001_intro_job',
  name: 'Type001導入型（就活）',
  description: 'Type001就活用の導入テンプレート。iida.png使用、ピンク背景',
  suitableFor: {
    contentTypes: ['導入', '問題提起', 'イントロダクション'],
    genres: ['就活', '転職', 'キャリア', 'Type001'],
  ...
  keywords: ['導入', '問題提起', 'Type001', '就活', '転職']
}