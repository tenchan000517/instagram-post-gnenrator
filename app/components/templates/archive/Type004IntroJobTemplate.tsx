...
interface Type004IntroJobTemplateProps {
  data: {
    title?: string;
...
export default function Type004IntroJobTemplate({ data }: Type004IntroJobTemplateProps) {
  const {
    title = '',
    targetAudience = '',
    problems = [],
...
export const type004IntroJobMetadata: TemplateMetadata = {
  id: 'type004_intro_job',
  name: 'Type004導入型（就活）',
  description: 'Type004就活用の導入テンプレート。iida.png使用、ピンク背景',
  suitableFor: {
    contentTypes: ['導入', '問題提起', 'ツール紹介', 'サービス紹介'],
    genres: ['就活', '転職', 'ツール', 'Type004'],
  ...
  keywords: ['導入', '問題提起', 'Type004', '就活', 'ツール']
}