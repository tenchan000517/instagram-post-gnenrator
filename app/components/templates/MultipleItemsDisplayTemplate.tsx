...
interface MultipleItemsDisplayTemplateProps {
  data: TemplateData
}
...
// メタデータ
export const multipleItemsDisplayMetadata = {
  id: 'multiple_items_display',
  name: '複数アイテム表示型',
  description: '2-5個のアイテムをカード形式で柔軟にレイアウト表示するテンプレート',
  suitableFor: {
    contentTypes: ['複数項目紹介', 'カテゴリ詳細', 'ツール紹介', '方法論'],
    genres: ['ナレッジ系', 'ノウハウ系', '実践系'],
    dataStructure: ['複数アイテム', '詳細説明'],
  ...
  keywords: ['複数', 'アイテム', 'カード', 'レイアウト', '柔軟', '詳細']
}