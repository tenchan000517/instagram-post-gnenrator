...
| KnowledgeID | PostType | TargetAudience | PersonaID | ProblemDescription | Pattern |
|-------------|----------|----------------|-----------|-------------------|---------|
| K030 | 001 | T003 | P030 | 27歳でガクチカ書くことないと悩んでいる | 順序依存型ステップフロー（問題共感開始型） |
...
| KnowledgeID | PostType | TargetAudience | PersonaID | ProblemDescription | Pattern |
|-------------|----------|----------------|-----------|-------------------|---------|
| K027 | 001 | T003 | P027 | 面接で聞かれて困った質問に心臓止まりそうになる | 並列紹介型（Q&A形式） |
...
| KnowledgeID | PostType | TargetAudience | PersonaID | ProblemDescription | Pattern |
|-------------|----------|----------------|-----------|-------------------|---------|
| K115 | 001 | T005 | P115 | 副業や複業で失敗続きで何をすれば良いかわからない | エピソード並列紹介型 |
...
| K041 | 001 | T003 | P041 | 大学3年7月時点でのアドバイスが欲しい | 体験談共有型教育（経験者指針） |
...
| K063 | 001 | T001 | P063 | 上司との関係でNG行動をしてしまい正しい対処法を知りたい | 対比型認識変革（NG行動→正しい対処法） |
...
| KnowledgeID | PostType | TargetAudience | PersonaID | ProblemDescription | Pattern |
|-------------|----------|----------------|-----------|-------------------|---------|
| K032 | 001 | T001 | P032 | 髪を黒髪にしてないことで就活への不安を抱いている | 時系列ストーリー型（8段階体験談） |
...
| K065 | 001 | T001 | P065 | 優等生系無能タイプの悩み解決 | 感情共感型問題解決 |
